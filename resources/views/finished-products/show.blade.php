...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6">
                        <div class="p-3 bg-success bg-opacity-10 rounded text-center">
                            ...
                            <h3 class="mb-0 fw-bold text-dark">{{ number_format($finishedProduct->stock_on_hand, 0) }}</h3>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-sm table-borderless">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <code style="font-size:.78rem;background:#f1f5f9;padding:.15rem .5rem;border-radius:4px">
    ...
    <!-- Barcode Card + Production Actions stacked -->
    <div class="col-lg-6">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-dark text-white py-2">
                <h6 class="mb-0"><i class="bi bi-upc-scan me-2"></i>Product Barcode</h6>
            </div>
            <div class="card-body text-center py-4">

                {{-- Live barcode preview --}}
                <div class="d-inline-block border border-2 border-dashed rounded p-3 mb-3 bg-white">
                    <svg id="bc-svg"></svg>
                    <div class="mt-2" style="font-size:.72rem;font-weight:700;color:#334155;letter-spacing:.5px;text-transform:uppercase">
                ...
                <button class="btn btn-dark px-4" onclick="bcDownload()">
                    <i class="bi bi-download me-2"></i>Download Barcode PNG
                </button>
        ...
        @if($finishedProduct->product_type === 'manufactured')
            ...
            @if(!$pendingMix)
            <div class="card shadow-sm border-success mb-4" style="border-width: 2px;">
...
(function () {
    ...
    const NAME = @json($finishedProduct->name);
